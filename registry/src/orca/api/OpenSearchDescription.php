...
print('<Url type="text/xml" template="'.esc(eAPP_ROOT).'/search?term={searchTerms}&amp;format=xml&amp;count={count}&amp;temporal={temporal}&&g={geometry}&&b={bounding box}" />'."\n");
print('<Url type="application/x-suggestions+json" template="'.esc(eAPP_ROOT).'/search?term={searchTerms}&amp;format=json&amp;count={count}&amp;temporal={temporal}&&g={geometry}&&b={bounding box}" />'."\n");
