	    ...
	    <xsl:choose>
	        ...
	        <xsl:otherwise>
	            <div id="metadataTitle">
	                <span>METADATA</span>
	                <h1 itemprop="name"><xsl:value-of select="../ro:collection/ro:name/ro:namePart"/></h1>
   ...
   <div id="metadataContent">
       <div class="left">
           <!-- Author -->
            ...
            <xsl:if test="ro:relatedObject/ro:relation[@type='distributor']">
                <h2>Organisation</h2><p><xsl:apply-templates select="ro:relatedObject/ro:relation[@type='distributor']"/></p>   
            </xsl:if>
                    ...
                    <p>
                        ...
                        <xsl:variable name="dateResult">
                            <xsl:call-template name="format-date">
                                <xsl:with-param name="date"><xsl:value-of select="substring(./@dateModified,1,10)"/></xsl:with-param>
       ...
       <div class="right">
        ...
        <ul class="moreInformation">
            <!--Spatial Coverage-->
            <xsl:choose>
                <xsl:when test="ro:coverage/ro:spatial or ro:location/ro:spatial">
                    <li class="noprint">  
                        <h2 class="meta_title">
                        ...
                        <div class="content expand">
                            ...
                            <xsl:if test="ro:coverage/ro:spatial/ro:center | ro:location/ro:spatial/ro:center">
                                <xsl:apply-templates select="ro:coverage/ro:spatial/ro:center | ro:location/ro:spatial/ro:center"/>
                            </xsl:if>
...
<!--  the following templates will format the view page content -->
 ...
 <xsl:template match="ro:relatedObject/ro:relation[@type='author']">
    <xsl:value-of select="substring-before(../ro:key,'-')"/>&#160; 
</xsl:template>
...
-->                
   ...
   <xsl:template match="ro:location[@dateFrom!=''] | ro:location[@dateTo!='']">
    ...
    <xsl:template match="ro:subject">            
            <li class="subjectFilter" id="."><xsl:value-of select="."/></li>
    </xsl:template>
