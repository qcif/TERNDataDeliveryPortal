...
<div id="footer" class="no_print">
	...
	<script type="text/javascript" src="http://maps.google.com/maps/api/js?v=3.5&sensor=false"></script> <!--Google Map v3 from Google-->
	...
	<script type="text/javascript" src="<?php echo base_url();?>js/jquery.cookie.js"></script> <!-- jQuery UI-->
        <script type="text/javascript" src="<?php echo base_url();?>js/markerclusterer.js"></script> <!-- Marker Clusterer-->
