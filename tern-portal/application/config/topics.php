...
?>
   { 
       "docs": [
            {
                "key": "plants_and_animal",
                "title": "Plants & Animals",
                "img_url": "/img/topics/plants_and_animals.png",                 
                "query_url": "<?php echo base_url();?>search#!\/q=(verte* OR inverte*) OR (fauna OR animal) OR (flora OR plant) OR (species OR biota) OR biodiversity\/p=1\/tab=collection\/num=10" 

            },
           {
                "key": "vegetation",
                "title": "Vegetation",
                "img_url": "/img/topics/vegetation.png",                 
                "query_url": "<?php echo base_url();?>search#!\/q=(vegetation OR revegetation) OR biomass OR canopy OR reforestation OR carbon OR %22tree ring*%22\/p=1\/tab=collection\/num=10" 
