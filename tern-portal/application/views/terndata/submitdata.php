...
<div id="staticContentWhite">
    ...
    <p class="datatext">One of the aims of TERN is to collectively increase the research capacity of the Australian ecosystem science community by collecting, storing, sharing and enabling integration of data across different disciplines. Please contact <a href="tern.data@uq.edu.au"> TERN Data Integration and Synthesis Coordinator</a> at first instance to discuss any data contribution to TERN. Further information regarding the contribution of data and expertise is provided below for each TERN Facility.</p>
