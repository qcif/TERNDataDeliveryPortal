...
(
 ...
 WHERE ( $2 ~* registry_object_class OR $2 = '' )
   ...
   AND ( registry_object_key ~* $1
        OR $1 = '' OR originating_source~* $1 OR data_source_key~* $1 OR data_source_title~* $1 OR object_group~* $1 OR created_who~* $1 OR registry_object_class~* $1 OR type~* $1 OR identifier_value~* $1 OR identifier_type~* $1 OR status~* $1 OR record_owner~* $1 OR list_title~* $1 OR display_title~* $1 OR description_title~* $1 OR description_value~* $1
   )
